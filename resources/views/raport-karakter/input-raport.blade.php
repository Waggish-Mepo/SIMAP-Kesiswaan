            ...
            <div class="content">
                ...
                <div class="h-screen mr-4 ml-24 w-58 bg-white rounded-lg border shadow-md sm:p-2 dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <form class="px-4 py-2 space-y-6 sm:pb-6 xl:pb-8" action="#">
                        <div class="flex">
                            <label for="nis" class="block mt-2 mr-2 text-sm font-medium text-gray-900 dark:text-gray-300">Rombel : </label>
                            <select id="rombel" class="bg-zinc-100 border border-indigo-800 text-gray-900 text-xs rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-28 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            ...
                            <select id="tingkat" class="ml-2 bg-zinc-100 border border-indigo-800 text-gray-900 text-xs rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-28 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            ...
                            <select id="rombel" class="ml-2 bg-zinc-100 border border-indigo-800 text-gray-900 text-xs rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-28 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    ...
                    <!-- LIST DATA RAPORT -->
                    <div class="mt-2 w-58 bg-blue-800 rounded-t-xl border shadow-inner sm:p-2 dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <table class="min-w-full">
                                        ...
                                        <tbody>
                                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                                ...
                                                <td class="py-4 px-6 text-sm text-center text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                    Baik
                                                </td>
                                                <td class="py-4 px-6 text-sm text-center text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                    Baik
                                                ...
                                                <td class="float-right py-4 px-4">
                                                    <a href="#" data-modal-toggle="edit-rapot-modal" class="text-blue-800 dark:text-blue-500 hover:underline"><svg style="width:18px;height:24px" viewBox="0 0 24 24">
...
<!-- MODAL INPUT RAPOT -->
<div id="input-raport-modal" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed right-0 left-0 top-4 z-50 pt-72 pb-4 justify-center items-center h-modal md:h-full md:inset-0">
    <div class="relative px-4 w-full max-w-lg h-full md:h-auto">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div class="flex justify-end p-2">
                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-toggle="input-raport-modal">
            ...
            <form class="px-6 pb-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8" action="#">
                ...
                <div class="flex">
                    <label for="integritas" class="mt-2 block text-sm font-medium text-gray-900 dark:text-gray-300">Integritas</label>
                    <select id="integritas" class="bg-gray-50 ml-8 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                <div class="flex">
                    <label for="religius" class=" mt-2 mr-1 block text-sm font-medium text-gray-900 dark:text-gray-300">Religius</label>
                    <select id="religius" class="bg-gray-50 ml-10 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <option selected=" " disabled>Pilih Nilai</option>
                        <option>Sangat Baik</option>
                        <option>Baik</option>
                        <option>Cukup</option>
                ...
                <div class="flex">
                    <label for="nasionalis" class="block mt-1 mr-3 text-sm font-medium text-gray-900 dark:text-gray-300">Nasionalis</label>
                    <select id="nasionalis" class="bg-gray-50 ml-4 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <option selected=" " disabled>Pilih Nilai</option>
                        <option>Sangat Baik</option>
                        <option>Baik</option>
                        <option>Cukup</option>
                ...
                <div class="flex">
                    <label for="mandiri" class="block text-sm mt-2 font-medium text-gray-900 dark:text-gray-300">Mandiri</label>
                    <select id="mandiri" class="bg-gray-50 ml-12 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <option selected=" " disabled>Pilih Nilai</option>
                        <option>Sangat Baik</option>
                        <option>Baik</option>
                        <option>Cukup</option>
                ...
                <div class="flex">
                    <label for="gotongRoyong" class="block text-sm mr-1 font-medium text-gray-900 dark:text-gray-300">Gotong Royong</label>
                    <select id="gotongRoyong" class="bg-gray-50 ml-4 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
...
<!-- MODAL EDIT RAPOT -->
<div id="edit-rapot-modal" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed right-0 left-0 top-4 z-50 pt-72 pb-4 justify-center items-center h-modal md:h-full md:inset-0">
    <div class="relative px-4 w-full max-w-lg h-full md:h-auto">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div class="flex justify-end p-2">
                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-toggle="edit-rapot-modal">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                </button>
            </div>
            <form class="px-6 pb-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8" action="#">
