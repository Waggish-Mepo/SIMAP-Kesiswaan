...
@Section('content')
@include('surat.peringatan.modal.create')
    <div class="flex flex-col ml-10 mr-6">
        <div class="w-58 bg-white rounded-lg border shadow-md sm:p-2 dark:bg-gray-800 dark:border-gray-700">
            <b class="pl-2 text-base text-gray-900 sm:text-base">Surat Peringatan Siswa</b>
        </div>
            ...
            <div class="inline-block min-w-full align-middle dark:bg-gray-800">
                <div id='recipients' class="p-8 mt-6 lg:mt-0 rounded shadow bg-white">
                    <button
                        ...
                        type="button" data-modal-toggle="create-peringatan"><i class="fa-solid fa-plus"></i>
                        Tambah</button>
                    <table id="example" class="table table-striped text-sm" style="width:100%;">
                        <thead>
                            <tr>
                                ...
                                <th data-priority="3">Surat Peringatan Ke-</th>
                        ...
                        <tbody>
                            @foreach ($data as $d)
                                <tr>
                                    ...
                                    <td class="text-center">{{ $d->sp_ke }}</td>
                                    ...
                                    <td class="grid grid-cols-2">
                                        <button type="button" data-modal-toggle="edit-peringatan-{{ $d->id }}"
                                        ...
                                        @include('surat.peringatan.modal.edit')
                                        ...
                                        @include('surat.peringatan.modal.delete')
                                        @if ($d->status == 0)
                                        <form action="{{ route('peringatan.proses', $d->id) }}" method="POST"
                                            class="col-span-2">
                                            @csrf
                                            @method('PUT')
                                            <button type="submit"
