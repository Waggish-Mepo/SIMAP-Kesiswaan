            ...
            <div class="p-6 space-y-6">
                <form action="{{ route('temuan.ambil', $d->id) }}" method="POST" enctype="multipart/form-data" autocomplete="off" >
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" value="{{ $d->penemu }}" name="penemu" id="nis" list="Penemu" class="bg-gray-300 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required readonly>
                        <datalist id="Penemu">
