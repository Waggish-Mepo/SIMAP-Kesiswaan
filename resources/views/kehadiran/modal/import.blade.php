<div id="import-file-modal" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div class="flex justify-end p-2">
                ...
                <button type="button"
                    ...
                    data-modal-toggle="import-file-modal">
            ...
            <form class="pb-4 space-y-6 lg:px-8 px-4 xl:pb-8" action="/absen/kehadiran/input" enctype="multipart/form-data"
                method="POST" autocomplete="off">
                @csrf
                <div class="flex">
                    <label for="foto_selfie_sim" class="block text-sm font-medium text-gray-900 dark:text-gray-300">Upload File</label>
                    <input type="file" name="file" id="foto_selfie_sim"
